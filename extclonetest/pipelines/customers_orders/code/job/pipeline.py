...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "13876/pipelines/customers_orders")
    MetricsCollector.start(spark = spark, pipelineId = "13876/pipelines/customers_orders")
    pipeline(spark)
