...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "324/pipelines/customers_orders")
    MetricsCollector.start(spark = spark, pipelineId = "324/pipelines/customers_orders")
    pipeline(spark)
