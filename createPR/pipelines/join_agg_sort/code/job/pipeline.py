...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "13876/pipelines/join_agg_sort")
    MetricsCollector.start(spark = spark, pipelineId = "13876/pipelines/join_agg_sort")
    pipeline(spark)
