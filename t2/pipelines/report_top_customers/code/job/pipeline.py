...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "357/pipelines/report_top_customers")
    MetricsCollector.start(spark = spark, pipelineId = "357/pipelines/report_top_customers")
    pipeline(spark)
